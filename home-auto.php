...
<?php
    ...
    if(!isset($_SESSION['user'])){
        ...
        if($_SESSION['v']==0){
            ...
            echo "<br>GO BACK : <a href='main.php'>BACK</a>";
                ...
                $a= $_SESSION['user'];
        $res=mysqli_query($db,"SELECT college,YEAR(year) y FROM alumni where alumni_id='$a' ");
        $cname='';
				$y = '';
    ...
    $show = mysqli_query($db,"SELECT alumni.name,chattb.chatbody,chattb.chatdate,alumni.alumni_id FROM alumni INNER JOIN chattb ON alumni.alumni_id = chattb.userid where alumni.college = '$cname' and YEAR(alumni.year) = '$y' ORDER BY chattb.chatdate LIMIT 50");
    $cur_bg = "skyblue";
    $cur_txt = "white";
