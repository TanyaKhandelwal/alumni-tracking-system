...
if(!isset($_SESSION['user'])){
    ...
    $a=$_SESSION['alumni'];
    $sql="SELECT * FROM alumni where rno='$a' and verified!='1' and verified!='0' ";
    ...
    $mail->Subject = 'Not Verified Successfully';
    $mail->Body    = '<h3 align=center> Hi '.$res['name'].'<br> your User Id: '.$res['alumni_id'].'<br> you have <b> not Verified successfully </b> by your college because there is some fault in your credentials like college name or roll number!!<br>Please update your profile <b>within a month</b> with correct credentials to enjoy the facilities, else your registration is deleted.</h3>';
    ...
    if(!$mail->send()) {
        ...
        echo "<script> alert('MAIL HAS BEEN SENT SUCCESSFULLY. INFORMING OF UNSUCCESSFUL VERIFICATION') </script>";
