...
<body style="background-image:url('images/Dock.jpg')">
<center>
	<div id="main">
		<h1>
			...
			<tr>
				...
				<td>
					<select name="msgbox" id="msgbox" onchange="return piliBG();">
						<option value="skyblue" id="skyblue">skyblue</option>
						...
						<option value="yellowgreen" id="yellowgreen">yellowgreen</option>
			...
			<tr>
				...
				<td>
					<select name="txt-color" id="txt-color" onchange="return piliTXT();">
						<option value="skyblue" id="skyblue">skyblue</option>
						<option value="white" id="red">white</option>
						<option value="orange" id="orange">orange</option>
						<option value="blue" id="blue">blue</option>
						<option value="pink" id="pink">pink</option>
						<option value="yellow" id="yellow">yellow</option>
