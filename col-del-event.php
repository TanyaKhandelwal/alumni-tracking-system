...
if(isset($_POST['delete'])){
    ...
    if(mysqli_num_rows($res)){
        mysqli_query($db,"DELETE from col_event where id= '$a' and college = '$b'");
        echo "<script> alert('EVENT DELETED SUCCESSFULLY')</script>";
        header("Refresh:0.05; url= main3.php");
        // echo "<br><a href='notice.php'>BACK</a>";
    }
    else{
        echo "<script> alert('No such event found!')</script>";
        header("Refresh:0.05; url= col-del-event.php");
    }
}
}
?>
...
<a href="main3.php" style=" color:white; font-size:20px; align:center;"><button type="submit" name="back" class="btn">Back</a></button>
    ...
    <form action="col-del-event.php" method="POST">
        <p>Event id:</p>
